...
public class KryptoGUI extends Applet{

	private JApplet jApplet = null;
	...
	public JApplet getJApplet() {
		if (jApplet == null) {
			jApplet = new JApplet();
			jApplet.setSize(new java.awt.Dimension(396,373));
			jApplet.setPreferredSize(new java.awt.Dimension(400,400));
