 ...
 *
 */
public class WordDivisionGUI extends JPanel implements ActionListener{
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("Word Division");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        WordDivisionGUI wdg = new WordDivisionGUI();
        
        frame.setContentPane(wdg.getJContentPane());
        wdg.init();
